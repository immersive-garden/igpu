...
function pickTranscodeTarget(device: GPUDevice): { target: any; format: string } {
...
export class KTXTexture extends Texture {
    ...
    constructor(gpu: GPU, { src, usage = GPUTextureUsage.TEXTURE_BINDING | GPUTextureUsage.COPY_DST, label = 'KTXTexture' }: KTXTextureOptions = {}) {
    ...
    async #load(url: string): Promise<void> {
        ...
        let format: string = header.format!;
