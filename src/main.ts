...
function renderLanding() {
    ...
    const items: Array<{ section?: string; view?: string; label?: string; folder?: string }> = [
        ...
        { view: 'skinninggltf', label: 'Skinning (glTF) + Shadows', folder: 'skinninggltf' },
    ];
    ...
    const codeIcon = document.querySelector('.CodeIcon') as HTMLAnchorElement;
    const exampleLinks = [...document.querySelectorAll('a.Example')] as HTMLAnchorElement[];
    ...
    document.querySelector('.SideIcon')!.addEventListener('click', (e: Event) => {
        e.preventDefault();
