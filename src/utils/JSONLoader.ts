...
export const loadJSON = async (url: string, opts?: RequestInit): Promise<any> => {
...
export const loadJSONAll = (urls: string[], opts?: RequestInit): Promise<any[]> => Promise.all(urls.map((url) => loadJSON(url, opts)));
