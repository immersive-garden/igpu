...
export class Particles {
    ...
    positionBufferRead!: GPUBuffer;
    positionBufferWrite!: GPUBuffer;
    computeShader!: ComputeShader;
    simUniforms!: StructuredView;
    simUniformBuffer!: GPUBuffer;
    velocityUniforms!: StructuredView;
    velocityUniformBuffer!: GPUBuffer;
    simBindGroups!: GPUBindGroup[];
    ...
    async init() {
        ...
        const simEntries = (readBuffer: GPUBuffer, writeBuffer: GPUBuffer): GPUBindGroupEntry[] => [
        ...
        const pingPong: [GPUBuffer, GPUBuffer][] = [
    ...
    update = () => {
        ...
        const pass = encoder.beginComputePass({ label: 'sim-compute-pass' });
