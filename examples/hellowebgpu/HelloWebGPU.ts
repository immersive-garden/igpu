...
export class HelloWebGPU {
    ...
    secondBox!: Mesh;
    thirdBox!: Mesh;
    secondScale!: UniformStructTarget;
    secondAlpha!: UniformStructTarget;
    thirdScale!: UniformStructTarget;
    thirdAlpha!: UniformStructTarget;
    params!: { rotate: boolean; speed: number };
    gui!: GUI;
    ...
    async init() {
        ...
        const scaleAlphaEntries = (uniformBuffer: GPUBuffer, scale: UniformStructTarget, alpha: UniformStructTarget): GPUBindGroupEntry[] => [
