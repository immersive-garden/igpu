...
interface TextureSlotDescriptor {
    format: GPUTextureFormat;
    usage?: GPUTextureUsageFlags;
    label?: string;
}
...
export class RenderTarget {
    ...
    _textures: TextureSlotDescriptor[];
    ...
    constructor(
        ...
        textures: TextureSlotDescriptor[] = []
    ) {
        this.gpu = gpu;
        this.label = label;
    ...
    onResize({ width, height, depth }: { width?: number; height?: number; depth?: number } = {}): void {
