...
export class InstancingPicking {
    ...
    hitsBuffer!: GPUBuffer;
    compute!: ComputeShader;
    pickKernel!: any;
    threadGroups!: number;
    pickUniforms!: StructuredView;
    ...
    async init() {
        ...
        this.pickUniforms = makeStructuredView((this.compute.defs as any).uniforms.uniforms);
    ...
    update = () => {
        ...
        this.raycast.castMouse(this.camera, this.ndc as [number, number]);
