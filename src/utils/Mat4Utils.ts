 ...
 */
export const compose = (dstMat: ArrayLike<number> & { [index: number]: number }, srcRotation: ArrayLike<number>, srcTranslation: ArrayLike<number>, srcScale: ArrayLike<number>): typeof dstMat => {
    const te = dstMat;
 ...
 */
export function decompose(srcMat: any, dstRotation: any, dstTranslation: { [index: number]: number }, dstScale: { [index: number]: number }): void {
